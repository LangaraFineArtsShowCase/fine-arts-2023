  ...
  return (
    <main>
      ...
      <section>
        <div>
          <h1>Fine Arts</h1>
          <h2>Graduation Exhibition <small>2023</small></h2>
          <div>
      ...
      <section>
        <div>
          ...
          <div>
            <p>For information on admissions to the Langara Fine Arts program contact<br /><strong>admissions@langara.ca</strong></p>
            <p>
              <a href="mailto:admissions@langara.ca">Apply online today!</a>
            </p>
          </div>
        </div>
      </section>
